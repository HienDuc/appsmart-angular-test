...
## Required Technologies
 - [AngularJS v1.6](https://angularjs.org/)
...
- All the static data such as JS, SASS, CSS, Font and Image Files must be inside `/html` directory. Each one inside your own directory.
- **You're not allowed to use jQuery (!important)** (You must not use jQuery at all. There are alternatives for developing bootstrap projects with AngularJS)
